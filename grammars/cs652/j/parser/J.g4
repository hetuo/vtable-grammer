...
fieldDeclaration returns [Type type, int flag]
    :   typeType Identifier ';'
    ;

methodDeclaration   returns [Scope scope, Type tyep, int flag]
...
formalParameter returns [Type type, int flag]
    :   typeType Identifier
    ;
...
localVariableDeclaration returns[Type type, int flag]
    :    typeType Identifier
    ;
